...
const WishList = () => {
  ...
  // }, [wishlist, stripeToken, wishlistTotal, history]);
  const quantity = useSelector(state => state.wishlist.quantity)
  //see if you need to remove wishlist or not
  return (
    <Container>
      <Navbar />
      <Announcement />
        ...
        <Bottom>
              ...
              <Product>
                ...
                <PriceDetail>
                  <ProductAmountContainer>
                    {/* <Add type="button" onClick={incNum} /> */}
                    <ProductAmount>
                      {/* {num} */}
                      {product.quantity} buc
                    </ProductAmount>
                    {/* <Remove type="button" onClick={decNum} /> */}
                  </ProductAmountContainer>
                  <ProductPrice>
          ...
          {/* <Summary>
            ...
            <StripeCheckout
              ...
              billingAddress
              shippingAddress
              description={`Your total is $${wishlistTotal}`}
              amount={wishlist.total * 100}
              token={onToken}
              stripeKey={KEY}
            >
